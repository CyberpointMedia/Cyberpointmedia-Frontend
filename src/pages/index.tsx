      ...
      <section className="bg-[#efeae3] py-16 2xl:pt-[350px] 3xl:pt-[60px]">
        <div className="container mx-auto 3xl:container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 mt-16 gap-7">
            ...
            whileInView={"show"}
            viewport={{once: true, amount: 0.1}}
            className="bg-white lg:p-12 p-4 shadow-sm card-hover border-t-8 border-white duration-500 transition hover:border-[#FF561D]">
                ...
                <h3 className="my-5 lg:text-4xl text-2xl font-aeonik duration-300 transition"><a href="javascript:void(0);">Design &amp; Engineering</a></h3>
            ...
            className="bg-white lg:p-12 p-4 shadow-sm card-hover border-t-8 border-white duration-500 transition hover:border-[#FF561D]">
                ...
                <h3 className="my-5 lg:text-4xl text-2xl font-aeonik"><a href="javascript:void(0);">Cloud &amp; DevOps</a></h3>
            ...
            className="bg-white lg:p-12 p-4 shadow-sm card-hover border-t-8 border-white duration-500 transition hover:border-[#FF561D]">
                ...
                <h3 className="my-5 lg:text-4xl text-2xl font-aeonik"><a href="javascript:void(0);">Digital Marketing</a></h3>
