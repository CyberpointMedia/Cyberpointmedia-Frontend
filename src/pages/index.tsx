        ...
        <div className="container mx-auto 3xl:container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 mt-16 gap-7">
            ...
            className="bg-white 2xl:p-12 xl:p-8 p-4 shadow-sm card-hover border-t-8 border-white duration-500 transition hover:border-[#FF561D]">
                ...
                <p className="md:line-clamp-3 2xl:line-clamp-4">Your online business needs to be appealing and functional for excellent user engagement. We bring your concepts to life through MVP Software Development and UI/UX Design.</p>
            </motion.div>
            ...
            className="bg-white 2xl:p-12 xl:p-8 p-4 shadow-sm card-hover border-t-8 border-white duration-500 transition hover:border-[#FF561D]">
                ...
                <p className="md:line-clamp-3 2xl:line-clamp-4">Our Cloud Consulting and DevOps services will enhance the agility and scalability of your projects. Harness the power of AWS, Azure and Google Cloud for agile development.</p>
            </motion.div>
            ...
            className="bg-white 2xl:p-12 xl:p-8 p-4 shadow-sm card-hover border-t-8 border-white duration-500 transition hover:border-[#FF561D]">
                ...
                <p className="md:line-clamp-3 2xl:line-clamp-4">Connect with existing and prospective clients through strategic digital marketing solutions. Our tailored strategies, including SEO and SMM, will drive growth and engagement.</p>
            </motion.div>
          </div>
          {/* service box end */}
        </div>
