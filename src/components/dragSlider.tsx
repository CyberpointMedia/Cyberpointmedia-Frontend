...
import showcaseImg1 from '@/assets/showcase-img1.jpg';
import showcaseImg2 from '@/assets/showcase-img2.jpg';
import showcaseImg3 from '@/assets/showcase-img3.jpg';
    ...
    <div className='relative overflow-hidden' id="drag-section">
        ...
        <div className="card">
            ...
            <div className="card-body md:pr-12">
                ...
                <p className="line-clamp-2">Financial service that offers premium credit cards with a unique health & wellness reward program.</p>
            </div>
            </div>
