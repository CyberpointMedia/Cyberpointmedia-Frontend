    ...
    <div>
      <section className="bg-[#efeae3] py-16">
            <div className="max-w-5xl mx-auto px-6">
               ...
               <h2 className="text-4xl md:text-5xl text-black mb-10 aeonik_trialregular">Frequently Asked Questions</h2>
                ...
                <div className="faq-accordion"> 
                  {faqs.map((faq, index) => (
                    <div key={index} className={`faq-item border-b border-[#DAD2C7] mb-4 pb-4 ${activeIndex === index ? 'active' : ''}`} onClick={() => toggleAccordion(index)}>
                      <div className="question text-xl font-normal text-[#2C2D36] aeonik_trialregular">{faq.question}</div>
