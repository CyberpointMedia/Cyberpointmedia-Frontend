...
const OurTechnology = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row items-center border-b border-[#DAD2C7] py-8 gap-6">
        <h2 className="tehcnology_name text-5xl text-[#878787] md:w-1/4 w-full text-center sm:text-left">Mobile App</h2>
    ...
    <div className="flex flex-col md:flex-row items-center border-b border-[#DAD2C7] py-8 gap-6">
    <h2 className="tehcnology_name text-5xl text-[#878787] md:w-1/4 w-full text-center sm:text-left">Front-end </h2>
    <div className="gap-3 flex flex-col md:w-3/4 sm:flex-row w-full flex-wrap items-center">
        <span className="text-xl bg-[#E7E2DC] rounded-full py-1 px-3 pe-4 flex items-center">
    ...
    <div className="flex flex-col md:flex-row items-center border-b border-[#DAD2C7] py-8 gap-6">
    <h2 className="tehcnology_name text-5xl text-[#878787] md:w-1/4 w-full text-center sm:text-left">Back-end</h2>
    <div className="gap-3 flex flex-col md:w-3/4 sm:flex-row w-full flex-wrap items-center">
        <span className="text-xl bg-[#E7E2DC] rounded-full py-1 px-3 pe-4 flex items-center">
    ...
    <div className="flex flex-col md:flex-row items-center border-b border-[#DAD2C7] py-8 gap-6">
    <h2 className="tehcnology_name text-5xl text-[#878787] md:w-1/4 w-full text-center sm:text-left">Database</h2>
    <div className="gap-3 flex flex-col md:w-3/4 sm:flex-row w-full flex-wrap items-center">
        <span className="text-xl bg-[#E7E2DC] rounded-full py-1 px-3 pe-4 flex items-center">
    ...
    <h2 className="tehcnology_name text-5xl text-[#878787] md:w-1/4 w-full text-center sm:text-left">Server</h2>
    <div className="gap-3 flex flex-col md:w-3/4 sm:flex-row w-full flex-wrap items-center">
        <span className="text-xl bg-[#E7E2DC] rounded-full py-1 px-3 pe-4 flex items-center">
