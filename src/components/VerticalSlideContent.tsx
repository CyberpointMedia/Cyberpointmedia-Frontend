        ...
        <section className=''>
            <div className='container 3xl:container mx-auto'>
                <div className='flex flex-col justify-between md:flex-row gap-3 md:gap-8 xl:gap-60'>
                    <Slider {...settings} className='w-full md:w-4/5 3xl:w-2/5 verticalSlide pt-4 md:pt-14 overflow-hidden h-fit'>
                            <motion.div 
                                variants={fadeIn("up", 0.1)}
                                initial="hidden"
                                whileInView={"show"}
                                viewport={{once: true, amount: 0.1}}
                                className='relative ps-10 xl:ps-32 md:ps-12 mb-20 h-screen'>
